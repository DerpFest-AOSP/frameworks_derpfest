...
<<<<<<< HEAD:core/java/org/derpfest/util/PowerMenuUtils.java
import org.derpfest.providers.DerpFestSettings;
=======
import org.derpfest.providers.DerpFestSettings;
import static org.derpfest.util.PowerMenuConstants.*;
>>>>>>> c98f5ab (core: Add a panic trigger to Global actions):core/java/org.derpfest/util/PowerMenuUtils.java
...
public final class PowerMenuUtils {
    public static boolean isAdvancedRestartPossible(final Context context) {
        ...
        boolean advancedRestartEnabled = Settings.Secure.getInt(context.getContentResolver(),
                DerpFestSettings.Secure.ADVANCED_REBOOT, 0) == 1;
