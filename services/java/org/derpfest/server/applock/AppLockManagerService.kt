...
package org.derpfest.server.applock
...
import com.android.server.derp.AppLockManagerServiceInternal
import com.android.server.notification.NotificationManagerInternal
import com.android.server.pm.UserManagerInternal
import com.android.server.wm.ActivityInterceptorCallback.ActivityInterceptorInfo
import com.android.server.wm.ActivityTaskManagerInternal

import org.derpfest.applock.AppLockData
import org.derpfest.applock.AppLockManager
import org.derpfest.applock.IAppLockManagerService
...
private const val ACTION_APP_LOCK_TIMEOUT = "org.derpfest.server.applock.AppLockManagerService.APP_LOCK_TIMEOUT"
...
class AppLockManagerService(
    ...
    class Lifecycle(context: Context) : SystemService(context) {
        ...
        override fun onStart() {
            publishBinderService(DerpFestContextConstants.APP_LOCK_SERVICE, service)
            service.onStart()
        }
